...
public class FileManger implements Serializable {
    ...
    public ArrayList<Object> read(String FilePath) {
        ...
        //  lecturer and his functions 
        //هنا هنحط الفانكشن بتاعت المحاضر
...
//هنا دى المواد محدش يغير فيها عشان عملتها خلاص
                if (seprated[6].equals("CS")) {
                    x.setDept(Main.cs);
                } else if (seprated[6].equals("IS")) {
                    x.setDept(Main.is);
            ...
            return (ArrayList<Object>) (Object) lecturer;

        } else if (FilePath.equals("TA.txt")) {
//مش عارفة هنحتاج الفانكشن دى ولا لا فعملاها كومنت
